...
Define a function that "abstracts" the km-to-miles conversion we did in [2.3: Our First Program](../2-basic-data-manipulation/4.2-our-first-program.md#metric-conversion-program).
