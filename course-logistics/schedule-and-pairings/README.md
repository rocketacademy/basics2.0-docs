...
1. Opening Brief
2. Look ahead: Deliverables for **Day 1:**
   1. [Required Hardware and Software](../required-hardware-and-software/)
   2. [Pre-Class Material](./#pre-class)
...
* [Mad Libs](https://basics.rocketacademy.co/in-class-exercises/day-5-scissors-paper-stone-redux)
