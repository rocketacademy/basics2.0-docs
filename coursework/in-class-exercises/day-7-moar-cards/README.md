...
Feel free to copy the card deck generation function from [9.2: Card Deck Generation](../../../modules/3-logic-and-control-flow/3.7-creating-objects-with-loops.md#card-deck-generation-code) and the card shuffling functions from [9.1: JavaScript Objects](../../../modules/1-data-types-structures-and-manipulations/1.4-objects.md#card-shuffling) into your `script.js` file.
