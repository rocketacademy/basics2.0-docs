...
Implement the High Card game from [9.1: Objects](../../../modules/1-data-structures-and-manipulation/1.4-javascript-objects.md#high-card) with 1 difference: the winner is the person with the _lowest_ card.
