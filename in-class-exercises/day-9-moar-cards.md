...
Implement the High Card game from [9.1: Objects](../9-javascript-objects/10.1-javascript-objects.md#high-card) with 1 difference: the winner is the person with the _lowest_ card.
