...
{% embed url="https://youtu.be/KPzqauQd3ks" %}
...
## Two Conceptual Types of Arrays

{% embed url="https://youtu.be/IlMwxLrCRig" %}

We can use arrays in 2 conceptual ways: to store static data and to store dynamic data.
...
![](https://s1.o7planning.com/en/12201/images/27916516.png)
...
{% embed url="https://youtu.be/eBGzl1zklIA" %}
...
There are 2 array **methods** we will use often in Coding Basics to add and remove elements from arrays: `push` and `pop`.

{% hint style="info" %}
Methods refer to pre-defined functions exclusively associated with certain data structures. `push` and `pop` can be used on Arrays, but are not universal functions.
{% endhint %}

![](https://preview.redd.it/ywbqyw9sum731.jpg?auto=webp\&s=9cf784073517d240aa35dd89526377ef9e3019f4)
...
See a list of all Array Methods [**here**](https://www.w3schools.com/js/js\_array\_methods.asp)**.**
...
{% embed url="https://codepen.io/rocket-basics/pen/WNXRoxW" %}
