...
We can also assign variables or even mathematical operations to `myOutputValue`. Our previous code from [3.2: Variables](../1-data-structures-and-manipulation/3.2-variables.md) looked like this.
