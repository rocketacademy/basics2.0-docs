...
In [3.3.1: Pseudo-Code, Boolean or](3.3.1-pseudo-code-boolean-or.md) we learned how to pseudo-code and use logical OR operators. In this module, we will learn about the following.
