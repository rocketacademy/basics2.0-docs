...
In [4.2: Pseudo-Code, Boolean Or](3.3.2-boolean-or.md) we learned how to pseudo-code and use logical OR operators. In this module we will learn about the following.
