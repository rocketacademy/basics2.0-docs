...
In the beginning, it was HTML and only HTML. But programmers wanted to add styling to their web pages to help distinguish themselves from others on the web. In October 1994, Håkon Wium Lie introduced Cascading Style Sheets (CSS) to the world.
