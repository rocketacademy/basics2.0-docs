...
{% hint style="warning" %}
Before the meeting, ask the students to put their [5.1 Functions](../modules/2-structuring-and-debugging-code/2.3-functions/2.3.1-functions.md) exercise code as a snippet in a thread in the Slack channel. As part of the message, ask them to rate their own understanding 1-5.
{% endhint %}
...
## [5.1: Functions](../modules/2-structuring-and-debugging-code/2.3-functions/2.3.1-functions.md)
