...
## [8.1: Program Lifecycle and Global State](../modules/4-scope/4.2-program-lifecycle-and-state.md)
...
1. [Day 4: Boolean And, GitHub, Program State](../coursework/in-class-exercises/day-3-boolean-and-program-state.md)
